  ...
  <SectionWrapper class="pb-10" :style="{'backgroundColor': businessInfo.primaryColor}">
    ...
    <div v-else>
        ...
        <div v-if="setScreen === Screens.ITEMS">
          ...
          <div class="" v-else>
            ...
            <div v-if="categories.length === 0">
              <div class="flex flex-col h-auto items-center space-y-2 h-[350px] justify-center">
      ...
      <div class="flex flex-col justify-center items-center">
        <img src="/imgs/logo-black.svg" class="w-10 opacity-10"/>
        <small class="my-2 text-gray-200 text-9px">Powered by dynomenu &copy; 2024</small>
      </div>
    </div>
...
const createOrder = () => {
  ...
  const data: IOrder = {
    ...
    serviceType: 'DINE_IN', // static for now
    tableNumber: 1
  }
